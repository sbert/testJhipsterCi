...
public class TestJhipsterCiApp {

    private static final Logger log = LoggerFactory.getLogger(TestJhipsterCiApp.class);

    private final Environment env;

    public TestJhipsterCiApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes testJhipsterCi.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TestJhipsterCiApp.class);
